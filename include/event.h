...
/**
 * @class cobraFileTransfer event.h "event.h"
 *
 * The cobraFileTransfer class is intended to provide necessary functions to make generating
 ...
 */
class cobraFileTransfer : QFile {
    Q_OBJECT

public:
    cobraFileTransfer(QString&);
    ~cobraFileTransfer();
 ...
 * handled as well, but is controlled via the cobraFileTransferController object in the
 * cobraTransferEventHandler class.
 *
 */
class cobraTransferController : QObject {
    Q_OBJECT
...
protected:
   ...
   QVector<cobraFileTransfer>   m_vcftTransfers;
};
